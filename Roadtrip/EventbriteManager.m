...
- (void)getEventsWithCoordinates: (CLLocationCoordinate2D) coordinate withStartDateUTC: (NSString *) startDateUTC completion:(void(^)(NSArray *categories, NSError *error))completion {
    ...
    NSString *urlString = [NSString stringWithFormat: @"https://www.eventbriteapi.com/v3/events/search/?token=DML5RT7O2YSNEXPFG3ZC&location.latitude=%@&location.longitude=%@&start_date.range_start=%@&location.within=20km", latitudeString, longitudeString, startDateUTC];
